...
const fetchWeatherData = async () => {
    try {
        const response = await fetch('http://api.weatherapi.com/v1/forecast.json?key=0e1291cb66fa437c943180330230910&q=Huejutla de Reyes&days=5&aqi=no&alerts=no');
...
const Clima = () => {
    ...
    // clima actual y el pronóstico semanal
    return (
        <LinearGradient colors={['#4c669f', '#3b5998', '#192f6a']} style={styles.linearGradient}>
